    ...
    <admin-layout title="Genres">
        ...
        <section class="mx-auto p-6">
            <div class="w-full flex mb-4 p-2 justify-end">
                <jet-button type="button" @click="generateGenres">
                        <svg
                            v-show="showSpinner"
                        ...
                        <div>
                          <span v-if="!showSpinner">Generate Genre</span>
...
export default defineComponent({
    ...
    methods: {
        ...
        generateGenres() {
            this.$inertia.post("/admin/genres", {}, {
              onStart: () => (this.showSpinner = true),
              onFinish: () => (this.showSpinner = false),
            });
        },
    },
});
