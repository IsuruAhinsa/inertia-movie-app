<template>
    <admin-layout title="Edit TvShow">
        <template #header>
        ...
        <section class="mx-auto p-6">
            <form @submit.prevent="updateTvShow">
                ...
                <div class="mt-4">
                    <jet-label for="created_year" value="Created Year" />
                    <jet-input
                        id="created_year"
                        type="date"
                        class="mt-1 block w-full"
                        v-model="form.created_year"
                    />
                    <jet-input-error :message="form.errors.created_year" class="mt-2" />
                </div>
...
export default defineComponent({
    ...
    setup(props) {
        const form = useForm({
            ...
            created_year: props.tvShow.created_year,
