    ...
    <section class="mx-auto p-6">
      <div class="w-full flex mb-4 p-2 justify-end">
        ...
        >
          ...
          <div class="p-1">
            <jet-button type="button" @click="generateTvShows">
              <svg
                v-show="showSpinner"
              ...
              <div>
                <span v-if="!showSpinner">Create Tv Show</span>
            ...
            >
              <Table>
                ...
                <TableRow v-for="tvShow in tvShows.data" :key="tvShow.id">
                  ...
                  <TableData>{{ tvShow.visits }}</TableData>
                  <TableData class="space-x-2">
                    <ButtonLink
                      class="bg-blue-500 hover:bg-blue-700"
                      :route="route('admin.seasons.index', tvShow.id)"
                    >
                      Seasons
                    </ButtonLink>
                    <ButtonLink
                      class="bg-green-500 hover:bg-green-700"
                      :route="route('admin.tv-shows.edit', tvShow.id)"
                    >
                      Edit
                    </ButtonLink>
                    <ButtonLink
                      ...
                      :route="route('admin.tv-shows.destroy', tvShow.id)"
                    >
                      Delete
                    </ButtonLink>
                  </TableData>
...
export default defineComponent({
  ...
  methods: {
    ...
    generateTvShows() {
      this.$inertia.post(
        "/admin/tv-shows",
        { tvShowTMDBId: this.tvShowTMDBId },
        {
